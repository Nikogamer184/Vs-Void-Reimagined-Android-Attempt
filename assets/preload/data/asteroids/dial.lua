...
if isStoryMode then
	...
	scaleObject('b', 1, 1)
	setProperty('b.alpha', 0.0001)
	
	makeLuaSprite('arrow', 'dial/arrow', 1250, 400)
	setScrollFactor('arrow', 0, 0)
	scaleObject('arrow', 0.5, 0.5)
	setProperty('arrow.alpha', 0.0001)
	
	makeLuaText('dialtutorial','', 480, 400, 100)
	setTextSize('dialtutorial', 20)
	setTextFont('dialtutorial', 'warface.ttf')
	setProperty('dialtutorial.alpha', 0.0001)
	
	addLuaSprite('v', true)
	addLuaSprite('b', true)
	addLuaSprite('arrow', true)
	addLuaSprite('box', true)
	addLuaText('dialtutorial', true)
end
end